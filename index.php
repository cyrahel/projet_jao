          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="pages/Liste_Livres.php">Liste</a></li>
                <li><a href="pages/Ajout_Livre.php">Ajout</a></li>
              </ul>
			  <li class="treeview">
              <a href="#"><i class='fa fa-link'></i> <span>Membres</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="pages/Liste_Membres.php">Liste</a></li>
                <li><a href="pages/Ajout_Membre.php">Ajout</a></li>
              </ul>
			  <li class="treeview">
              <a href="#"><i class='fa fa-link'></i> <span>Emprunts</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="pages/Liste_Emprunts.php">Liste</a></li>
                <li><a href="pages/Ajout_Emprunt.php">Ajout</a></li>
              </ul>
            </li>
          </ul><!-- /.sidebar-menu -->
        </section>
